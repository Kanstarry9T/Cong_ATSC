...
class Intersection(object):
    def __init__(self, id, intersection, world):
        ...
        self.signal = True if "lanes" in intersection.keys() else False
    ...
    def step(self, action, interval):
        ...
        # step for time of length interval
...
class World(object):
    """
    Create a OpenEngine engine and maintain informations about the world
    """

    def __init__(self, engine_cfg, world_config, thread_num, args, route=True):
    ...
    def _init_roadnet(self, config):
        ...
        print("non-virtual intersections: {}".format(len(self.intersection_ids)))
        ...
        for i in virtual_intersections:
            con_roads = i['start_roads'] + i['end_roads']  # 边缘路段ID
    ...
    def get_road_distance(self):
        ...
        for road_id, road in self.all_roads.items():
            ...
            for i in range(len([road.info["num_lanes"]])):#加了中括号
    ...
    def step(self, actions=None):
        ...
        # print("start: {}".format(self.eng.get_current_time()))
        self.eng.next_step()
